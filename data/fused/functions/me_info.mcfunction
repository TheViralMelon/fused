...
tellraw @s {"text":"Each of these items will permanently increase your Magic","color":"green"}
tellraw @s {"text":"Energy by 2 when consumed.","color":"green"}
tellraw @s " "
...
tellraw @s [{"text":"Ethereal Form duration increase limit: ","color":"dark_green"},{"score":{"name":"@s","objective":"fusedTransmute"},"color":"green","bold":true},{"text":" (max 10)","color":"green","bold":true}]
...
tellraw @s {"text":"(This can also be viewed on the meter replacing your hunger bar)","color":"green"}
