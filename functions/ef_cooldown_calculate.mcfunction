...
xp add @s[tag=!fusedMeCount,tag=!fusedAscended] -3 points
scoreboard players add @s[tag=!fusedMeCount] fusedMeTransfer 3
...
execute if entity @s[scores={fusedMeCounter=..10}] run function fused:ef_cooldown_calculate